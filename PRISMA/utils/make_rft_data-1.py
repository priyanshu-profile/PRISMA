...
def process_rft_train(data_dir_lst, tokenizer, limit=0):
    ...
    try:
        sft_train_file_first = f'model_outputs_nego_ex_UET_ME/{data_dir_lst[0]}/train/train_dpo_data.jsonl'
...
def main(cfg : DictConfig):
    ...
    with open(f'model_outputs_nego_ex_UET_ME/{data_dir}/train/train_rft_processed.jsonl', 'w', encoding='utf-8') as file:
