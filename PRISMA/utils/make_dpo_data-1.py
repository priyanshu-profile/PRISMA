...
def process_dpo_train(data_dir_lst, tokenizer, process_question_func, process_answer_func):
    ...
    dpo_train_file_first = f'model_outputs_nego_ex_UET_ME/{data_dir_lst[0]}/train/train_dpo_data.jsonl'
    ...
    for data_dir in data_dir_lst[1:]:
        dpo_train_file = f'model_outputs_nego_ex_UET_ME/{data_dir}/train/train_dpo_data.jsonl'
...
def main(cfg : DictConfig):
    ...
    with open(f'model_outputs_nego_ex_UET_ME/{data_dir}/train/train_dpo_processed.jsonl', 'w', encoding='utf-8') as file:
        for item in train_data:
            file.write(json.dumps(item) + '\n')

    eval_data = train_data[:320]
    with open(f'model_outputs_nego_ex_UET_ME/{data_dir}/train/eval_dpo_processed.jsonl', 'w', encoding='utf-8') as file:
